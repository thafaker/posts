...
slug: linux-fur-ppc-linux-auf-powerbook-g4-12
date_published: 2017-12-01T09:46:35.000Z
date_updated: 2020-12-23T13:52:35.000Z
tags: linux, ppc, powerbook g4 12", power pc, lubuntu, anleitung, howto, how-to
---

Was stellt man mit seinem alten **Powerbook G4 12"** an? OS X 10.5.8 ist schnarchend langsam und wird nicht mehr mit Sicherheitsupdates versorgt. Aktuelle Browser gibt es nicht mehr. Von zusätlicher Software wie Skype ganz abgesehen. Ansonsten funktioniert es aber. Und so bleibt man ratlos zurück. Oder nutzt genau diesen Umstand als Grund, warum man doch damit rum hacken sollte. So wie ich. 

![G4linux-715181](__GHOST_URL__/content/images/2017/11/G4linux-715181.jpg)
Foto by [shaos](http://shaos.net/blog/2008/04/refurbished-15-powerbook-g4.html)
...
Ich habe mir *Version 12.04* (Precise Pangolin) geladen ([hier der Download (archiviert)](http://web.archive.org/web/20221212193938/https://phillw.net/isos/lubuntu/precise/lubuntu-12.04-desktop-powerpc.iso)) und diese ISO auf CD gebrannt. Richtig, keine DVD-Distributon, auch die zusätzliche Software ist also als eher weniger denn allumfassend einzuordnen. Aber Ubuntu sei dank kann man alles nachinstallieren, sofern man denn etwas vermisst.
...
[Diese kurze Anleitung (archiviert)](http://web.archive.org/web/20151025055947/http://wiki.ubuntuusers.de:80/netatalk) befolgt ihr, und schon habt ihr nach 10 Minuten einen Linux-Rechner als Mac im Apple-Netz. Und vor allem ist AFP nach meiner Erfahrung viel schneller als Samba, die Dateifreigabe von Windows. Doch probiert selbst.

#### @-Zeichen Powerbook G4 Linux Terminal

Was habe ich geflucht, weil ich kein @ schreiben kann. Scheinbar mapped Linux das @-Zeichen auf die dritte Ebene, diese ist mit `ALT-GR` zu erreichen. Das Powerbook hat zwar zwei ALT-Tasten, jedoch keine GR. Und somit erreicht man die dritte Ebene nicht… und kann folglich auch kein @ oder € schreiben. Ich habe viele Anleitungen versucht, einige davon zielen darauf es unter der grafischen Oberfläche zu verändern, dann legt man es beispielsweise auf eine andere Taste. Jedoch hat man im Terminal, also der Linux-Console die nicht auf X läuft, immer noch kein @. Nun… es ist ganz simpel.
...
- [Ubuntu Linux 12.04 PowerPC PPC ISO 700 MB (archiviert)](http://web.archive.org/web/20221212193938/https://phillw.net/isos/lubuntu/precise/lubuntu-12.04-desktop-powerpc.iso) / ([Mirror](ftp://thafaker.crabdance.com/linux/lubuntu-12.04-desktop-powerpc.iso))
